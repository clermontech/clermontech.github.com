...
Je vais vous présenter Terraform, un outils pour gérer facilement le cycle de vie de vos ressources (VM, Bucket, DNS...) à travers plusieurs fournisseur de cloud (AWS, OVH ...). 
